  ...
  <el-container style="height: 100%; border: 1px solid #eee">
    <el-aside width="200px" height="100%" style="background-color:#545c64">
      ...
      >
        ...
        <el-submenu index="3">
          <template slot="title">
            <i class="el-icon-document"></i>添加数据
          </template>
          <el-menu-item-group>
            <el-menu-item index="3-1">
                <router-link to="/shopAdd">店铺添加</router-link>
            </el-menu-item>
            <el-menu-item index="3-2">
                <router-link to="/foodAdd">食品添加</router-link>
            </el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        ...
        <el-submenu index="5">
          ...
          <el-menu-item-group>
            <el-menu-item index="5-1">
                <router-link to="/edit">富文本编辑</router-link>
            </el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        ...
        <el-submenu index="6">
          ...
          <el-menu-item-group>
            <el-menu-item index="6-1">
                <router-link to="/set">用户设置</router-link>
            </el-menu-item>
